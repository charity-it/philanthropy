...
- Download Basic from http://drupal.org/project/philanthropy_theme
...
- if you want to change the name of the theme from 'philanthropy_theme' to another name like 'mytheme',
follow these steps (to do BEFORE enabling the theme) :

	- rename the theme folder to 'mytheme'
	- rename philanthropy_theme.info to mytheme.info
	- Edit philanthropy_theme.info and change the name, description, projet (can be deleted)
	- In philanthropy_theme.info replace [philanthropy_theme_block_editing] and [philanthropy_theme_rebuild_registry]
	  by [mytheme_block_editing] and [mytheme_rebuild_registry]
	- In template.php change each iteration of 'philanthropy_theme' to 'mytheme'
	- In theme-settings.php change each iteration of 'philanthropy_theme' to 'mytheme'
...
- philanthropy_theme.info => provide informations about the theme, like regions, css, settings, js ...
...
This is how the page template is buit in philanthropy_theme, and it works in fluid and fixed layout.
...
Once you start using philanthropy_theme, you will massively change it until a point where it has nothing
to do with philanthropy_theme anymore. Unlike ZEN, philanthropy_theme is not intended to be use as a base theme for a 
...
If you didn't rename your theme, but you don't want to be notified when philanthropy_theme has a new version
by the update module, simply delete "project = "philanthropy_theme" in philanthropy_theme.info
...
http://drupal.org/project/issues/philanthropy_theme
